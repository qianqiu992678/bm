<template>
	<div class="collector-dischargeAnalysis">
		...
		<div class="form-container">
			<div class="form-inline">
				...
				<div class="form-group yx-date-formGroup" style="position: relative;">
					...
					——
					<!--<date-picker v-model="dataParam.endTime" :config="datetimeconfig"></date-picker>-->
					<input type="text" class="startDate form-control"  v-model="dataParam.endTime" />
